...
const DashboardLayout = ({ children, hideSidebar = false, noPadding = false }) => {
  ...
  const navigation = {
    ...
    workflow: [
      { name: 'LinkedIn Cold Outreach', path: '/outreach', icon: FaPaperPlane, badge: 'Prosp Engine', badgeBg: 'bg-indigo-50 text-indigo-700 dark:bg-indigo-950/50 dark:text-indigo-300' },
