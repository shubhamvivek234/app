...
// CrossPost Logo Component
const CrossPostLogo = ({ size = 'default', showText = true, className = '' }) => {
  const sizes = {
    ...
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      <div className={`${currentSize.icon} relative`}>
        <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <linearGradient id="crossPostGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#6569f0" />
              <stop offset="100%" stopColor="#363cec" />
            </linearGradient>
          </defs>
          <circle cx="16" cy="16" r="16" fill="url(#crossPostGradient)" />
