...
const PLATFORM_META = {
  ...
  google_business: { icon: GoogleBusinessIcon, color: 'text-blue-600', label: 'Google Business' },
  gbp: { icon: GoogleBusinessIcon, color: 'text-blue-600', label: 'Google Business' },
};
