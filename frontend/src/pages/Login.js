          ...
          <div className="ring-track ring-outer">
            ...
            <div className="icon-pivot p8"><div className="icon-wrap">
              ...
              <svg viewBox="0 0 128 128">
                <rect width="128" height="128" rx="26" fill="#FFFC00" />
                <path fill="#000" d="M63.9 28c-14.7 0-24.2 9.4-24.2 24 0 7.1.8 11.8.8 16.3 0 2.2-2.3 4.3-5.3 6-5.2 3.1-6 7.2-6 9.3 0 5.6 4.7 9.8 10.4 9.8 1.4 0 2.9-.3 4.2-.9.4-.2.8-.2 1-.2.4 0 1 1 1.6 1.6 1.4 1.4 3.7 2.2 6.7 2.2a9.6 9.6 0 0 0 5.8-2.1c1-.8 1.8-.8 2.6-.8.8 0 1.6 1 2.3 1.8.3.3.6.6.9.9 2.5 2.5 5.5 3.3 8.3 3.3 5 0 8.7-2.6 11-4.7.6-.6 1.2-1 1.7-1 .8 0 1.6.3 2.3 1 2.8 2.8 6.1 3.7 9.2 3.7a10.4 10.4 0 0 0 10.4-10.4c0-3.3-3.1-6.1-6.1-8.3-5.3-4-6.4-9.4-6.4-17.7 0-14.7-9.5-24-24.2-24zm16.5 49c2 1.5 5 2.5 7.1 2.5 2 0 3-1 3-1.8 0-.9-1-1.3-1.6-1.5-1.4-.5-4.5-1.5-6.1-2.4-3.5-1.9-4.8-5-4.8-7.7 0-5.7 6.1-8.5 11.3-8.5 4.3 0 8.5 1.7 10.3 3a10.4 10.4 0 0 1 2.2 14.5c-3 3.2-8 3.5-10.6 3.5-2.2 0-3.8-.4-4.8-1l-6-3.7zm-22.3-9v4.5H41c.6-1.3 1.6-4.5 1.6-6 0-3.3-2-5.4-4.2-7-.6-.5-1.2-1-1.2-1.6 0-.8 1-1.8 3-1.8 5.2 0 11.3 2.8 11.3 8.5 0 2.7-1.3 5.8-4.8 7.7-1.3.8-3.4 1.5-4.8 2-1 .3-1.6.7-1.6 1.5 0 .8 1 1.8 3 1.8 2.1 0 5.1-1 7.1-2.5l6-3.7z" />
              </svg>
            </div></div>
          </div>
