...
const PLANS = [
  {
    ...
    features: [
      '6 social accounts',
      '150 posts / month',
      'Twitter: 60 tweets/mo (max 15 links)',
      '30 min AI video clipping (~12 shorts)',
  ...
  },
  {
    ...
    features: [
      ...
      'Unlimited posts (LinkedIn, IG, TikTok, etc.)',
      'Twitter: 180 tweets/mo (max 40 links) + BYOK',
...
const Billing = () => {
  ...
  const currentPlanId = (user?.plan === 'creator' ? 'pro' : user?.plan === 'business' ? 'agency' : user?.plan) || null;
