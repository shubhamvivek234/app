  ...
  return (
    <div className="login-root">
      <style>{`
        ...
        .login-root input[type="text"], .login-root input[type="email"], .login-root input[type="password"] {
          width: 100%;
          padding: 11px 14px;
          background: #f9f9f7;
          border: 1px solid rgba(0,0,0,0.08);
      ...
      <div className="left">
        <div className="form-wrap">
          ...
          <p className="sub">Start scheduling your content today</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="signup-line">Already have an account? <Link to="/login">Sign in</Link></p>
          </form>
        </div>
      </div>
          ...
          <div className="ring-track ring-outer">
            ...
            <div className="icon-pivot p8"><div className="icon-wrap">
              ...
              <svg viewBox="0 0 128 128">
                ...
                <path fill="#FFF" stroke="#000" strokeWidth="4" strokeLinejoin="round" d="M64 28.1c-14.8 0-24.3 9.4-24.3 24.1 0 7.1-.8 11.9-.8 16.4 0 2.2-2.3 4.3-5.3 6-5.3 3.1-6.1 7.2-6.1 9.4 0 5.6 4.7 9.8 10.4 9.8 1.4 0 2.9-.3 4.2-.9.4-.2.8-.2 1-.2.4 0 1 1 1.6 1.6 1.4 1.4 3.7 2.2 6.7 2.2a9.6 9.6 0 0 0 5.8-2.1c1-.8 1.8-.8 2.6-.8.8 0 1.6 1 2.3 1.8.3.3.6.6.9.9 2.5 2.5 5.5 3.3 8.3 3.3 5 0 8.7-2.6 11-4.7.6-.6 1.2-1 1.7-1 .8 0 1.6.3 2.3 1 2.8 2.8 6.1 3.7 9.2 3.7a10.4 10.4 0 0 0 10.4-10.4c0-3.3-3.1-6.1-6.1-8.3-5.3-4-6.4-9.4-6.4-17.7 0-14.7-9.5-24.1-24.3-24.1z" />
              </svg>
            </div></div>
          </div>
