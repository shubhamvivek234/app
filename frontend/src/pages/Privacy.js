  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Privacy Policy for CrossPost</h1>

        <div className="prose prose-slate max-w-none">
          <p className="text-gray-600 mb-6">Last Updated: 2026-02-11</p>

          <p className="text-gray-700 leading-relaxed mb-6">
            Thank you for using CrossPost ("we," "us," or "our"). This Privacy Policy outlines how we collect, use, and protect your personal and non-personal information when you use our website located at https://crosspost.com (the "Website").
          </p>
          <p className="text-gray-700 leading-relaxed mb-6">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              CrossPost uses YouTube API Services to enable cross-posting functionality to YouTube. By using our service to interact with YouTube, you are also subject to the YouTube Terms of Service (https://www.youtube.com/t/terms).
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              CrossPost is not intended for children, and we do not collect any data from children.
            </p>
          </section>
          ...
          <p className="text-gray-700 leading-relaxed mt-8 font-semibold">
            By using CrossPost, you consent to the terms of this Privacy Policy.
          </p>
        </div>
      </div>
